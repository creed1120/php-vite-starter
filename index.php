...
// require_existing('system/Database.php'); -> is loaded from the "spl_autoload_regeister" funciton
// require_existing('system/Response.php'); -> is loaded from the "spl_autoload_regeister" funciton
